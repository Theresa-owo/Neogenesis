...
public class BlockModelUtils {
    ...
    public static IBakedModel joinModelsCube(IBakedModel modelBase, IBakedModel modelAdd) {
        List<BakedQuad> list = new ArrayList(modelBase.getGeneralQuads());
    ...
    public static BakedQuad makeBakedQuad(EnumFacing facing, TextureAtlasSprite sprite, int tintIndex) {
        ...
        return facebakery.makeBakedQuad(vector3f, vector3f1, blockpartface, sprite, facing, modelrotation,
                blockpartrotation, flag, flag1);
    }
