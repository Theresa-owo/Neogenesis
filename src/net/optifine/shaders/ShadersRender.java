...
public class ShadersRender {
    ...
    public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks,
        ...
        int i = 240;
        worldrenderer.pos(x, y + offset, z + 1.0D).color(f1, f2, f3, 1.0F).tex(f4 + f6, f4 + f6).lightmap(i, i)
                .endVertex();
        worldrenderer.pos(x + 1.0D, y + offset, z + 1.0D).color(f1, f2, f3, 1.0F).tex(f4 + f6, f5 + f6).lightmap(i, i)
                .endVertex();
        worldrenderer.pos(x + 1.0D, y + offset, z).color(f1, f2, f3, 1.0F).tex(f5 + f6, f5 + f6).lightmap(i, i)
                .endVertex();
