                                                                ...
                                                                (modelPart.equals("rear_leg") ? modeldragon.rearLeg :
                                                                    (modelPart.equals("front_leg") ? modeldragon.frontLeg :
                                                                        (modelPart.equals("rear_leg_tip") ? modeldragon.rearLegTip :
                                                                            (modelPart.equals("front_leg_tip") ? modeldragon.frontLegTip :
                                                                                (modelPart.equals("rear_foot") ? modeldragon.rearFoot :
                                                                                    (modelPart.equals("front_foot") ? modeldragon.frontFoot :
                                                                                        (modelPart.equals("wing") ? modeldragon.wing :
                                                                                            (modelPart.equals("wing_tip") ? modeldragon.wingTip : null)))))))))));
        }
    }
