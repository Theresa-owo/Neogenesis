...
public class PlayerItemParser {
    ...
    private static int parseAttachModel(String attachModelStr) {
        if ((attachModelStr == null) || attachModelStr.equals("body")) {
            return 0;
        }
    ...
    public static ModelRenderer parseModelRenderer(JsonObject elem, ModelBase modelBase, int[] parentTextureSize,
        ...
        if (jsonarray1 != null) {
            for (int k = 0; k < jsonarray1.size(); ++k) {
                ...
                Json.getFloat(jsonobject2, "sizeAdd", 0.0F);
    ...
    private static int[][] parseFaceUvs(JsonObject box) {
        int[][] aint = { Json.parseIntArray(box.get("uvDown"), 4), Json.parseIntArray(box.get("uvUp"), 4),
