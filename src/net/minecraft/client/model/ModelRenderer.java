...
public class ModelRenderer {
        ...
        if (!this.isHidden && this.showModel) {
            ...
            if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F) {
                if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F) {
                    ...
                    if (this.childModels != null) {
                        for (ModelRenderer element : this.childModels) {
                            ((ModelRenderer) element).render(p_78785_1_);
                        }
                    }
    ...
    public void renderWithRotation(float p_78791_1_) {
        if (!this.isHidden && this.showModel) {
            ...
            if (this.childModels != null) {
                for (ModelRenderer element : this.childModels) {
                    ((ModelRenderer) element).render(p_78791_1_);
                }
            }
    ...
    private void compileDisplayList(float scale) {
        ...
        for (ModelBox element : this.cubeList) {
            ((ModelBox) element).render(worldrenderer, scale);
        }

        for (Object element : this.spriteList) {
            ModelSprite modelsprite = (ModelSprite) element;
    ...
    public void addSprite(float p_addSprite_1_, float p_addSprite_2_, float p_addSprite_3_, int p_addSprite_4_,
            int p_addSprite_5_, int p_addSprite_6_) {
        this.spriteList.add(new ModelSprite(this, this.textureOffsetX, this.textureOffsetY, p_addSprite_1_,
                p_addSprite_2_, p_addSprite_3_, p_addSprite_4_, p_addSprite_5_, p_addSprite_6_));
    }
    ...
    public ModelRenderer getChild(String p_getChild_1_) {
        ...
        if (this.childModels != null) {
            for (ModelRenderer element : this.childModels) {
                ModelRenderer modelrenderer = (ModelRenderer) element;
    ...
    public ModelRenderer getChildDeep(String p_getChildDeep_1_) {
        ...
        if (this.childModels != null) {
            for (ModelRenderer element : this.childModels) {
                ModelRenderer modelrenderer1 = (ModelRenderer) element;
