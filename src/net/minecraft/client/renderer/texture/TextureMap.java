    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
        ...
        while (true) {
            ...
            for (final TextureAtlasSprite textureatlassprite1 : this.mapRegisteredSprites.values()) {
                ...
                try {
                    ...
                    crashreportcategory.addCrashSectionCallable("Sprite size",
                            () -> textureatlassprite1.getIconWidth() + " x " + textureatlassprite1.getIconHeight());
                    crashreportcategory.addCrashSectionCallable("Sprite frames",
                            () -> textureatlassprite1.getFrameCount() + " frames");
            ...
            if (Config.equals(System.getProperty("saveTextureMap"), "true")) {
                ...
                TextureUtils.saveGlTexture("debug/" + this.basePath.replace('/', '_'), this.getGlTextureId(),
