...
public class OpenGlHelper {
    ...
    public static void initializeTextures() {
        ...
        try {
            oshi.hardware.CentralProcessor centralprocessor = (new SystemInfo()).getHardware().getProcessor();
            cpu = String.format("%dx %s", new Object[] { Integer.valueOf(centralprocessor.getLogicalProcessorCount()),
    ...
    public static void glUniform3(int location, IntBuffer values) {
        if (arbShaders) {
            ARBShaderObjects.glGetUniformivARB(ShaderManager.program, location, values);
        } else {
