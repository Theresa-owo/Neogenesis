...
import net.theresa.neogenesis.modules.culling.entityculling.EntityCullingMixins;
import net.theresa.neogenesis.modules.render.NoDeadAnimations;
import net.theresa.neogenesis.modules.render.NoFallingBlocks;
import net.theresa.neogenesis.modules.render.NoLightning;
...
public class RenderManager {
    ...
    public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn,
        ...
        this.playerViewX = FreeLookUtil.Instance.getPerspectiveToggled() ? FreeLookUtil.Instance.getCameraPitch() : playerViewX;
        this.playerViewY = FreeLookUtil.Instance.getPerspectiveToggled() ? FreeLookUtil.Instance.getCameraYaw() : playerViewY;
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks,
        ...
        if (entity instanceof EntityLightningBolt && NoLightning.Instance.getToggled()) {
            return true;
        } else if (entity instanceof EntityFallingBlock && new NoFallingBlocks().getToggled()) {
            return true;
        } else if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).getHealth() <= 0.0F && NoDeadAnimations.Instance.getToggled()) {
            return true;
        } else if (entity.loadedExtra && entity.extraNoRender) {
            return true;
        } else if (entity instanceof EntityPlayerSP && Minecraft.getMinecraft().gameSettings.thirdPersonView() == 0) {
            return false;
        } else if (EntityCullingMixins.RenderManager_doRenderEntity_Odddfft(this, entity, x, y, z)) {
            return true;
        }
        else
        {
