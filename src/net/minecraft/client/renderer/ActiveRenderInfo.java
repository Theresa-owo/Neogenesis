...
public class ActiveRenderInfo {
    ...
    public static void updateRenderInfo(EntityPlayer entityplayerIn, boolean p_74583_1_) {
        ...
        float f2 = FreeLookUtil.Instance.getPerspectiveToggled() ? FreeLookUtil.Instance.getCameraPitch() : entityplayerIn.rotationPitch;
        float f3 = FreeLookUtil.Instance.getPerspectiveToggled() ? FreeLookUtil.Instance.getCameraYaw() : entityplayerIn.rotationYaw;
