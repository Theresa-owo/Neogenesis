...
public class RenderChunk {
    ...
    public void setPosition(BlockPos pos) {
        ...
        for (RenderChunk renderChunkNeighbour : this.renderChunkNeighbours) {
            RenderChunk renderchunk = renderChunkNeighbour;
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!this.isChunkRegionEmpty(blockpos)) {
            ...
            for (Object e : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
                ...
                for (EnumWorldBlockLayer element : aenumworldblocklayer) {
                    EnumWorldBlockLayer enumworldblocklayer = element;
