...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
    ...
    public void reloadResources(List<IResourcePack> resourcesPacksList, boolean isLang) {
        this.clearResources();
        ...
        this.notifyReloadListeners(isLang);
    }
    ...
    private void notifyReloadListeners(boolean isLang)
    {
        for (IResourceManagerReloadListener iresourcemanagerreloadlistener : this.reloadListeners) {
            if (isLang && !(iresourcemanagerreloadlistener instanceof  LanguageManager)) continue;
