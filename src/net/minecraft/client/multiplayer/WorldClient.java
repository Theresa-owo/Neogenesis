...
import net.theresa.neogenesis.modules.itemanimations.Sneak;
...
public class WorldClient extends World {
    ...
    public WorldClient(NetHandlerPlayClient netHandler, WorldSettings settings, int dimension,
        ...
        super(new SaveHandlerMP(), new WorldInfo(settings, "MpServer"),
                WorldProvider.getProviderForDimension(dimension), true);
    ...
    public void removeAllEntities() {
        ...
        for (Entity element : this.unloadedEntityList) {
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        crashreportcategory.addCrashSectionCallable("Retry entities", () -> WorldClient.this.entitySpawnQueue.size() + " total; "
        ...
        crashreportcategory.addCrashSectionCallable("Server type", () -> WorldClient.this.mc.getIntegratedServer() == null ? "Non-integrated multiplayer server"
    ...
    public void playSoundAtPos(BlockPos pos, String soundName, float volume, float pitch, boolean distanceDelay) {
        this.playSound(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, soundName, volume, pitch,
                distanceDelay);
    }
