...
public class TileEntitySign extends TileEntity {
    ...
    public final IChatComponent[] signText = { new ChatComponentText(""), new ChatComponentText(""),
    ...
    public boolean executeCommand(final EntityPlayer playerIn) {
        ...
        for (IChatComponent element : this.signText) {
            ChatStyle chatstyle = element == null ? null : element.getChatStyle();
