...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable {
    ...
    public void processPlayerDigging(C07PacketPlayerDigging packetIn) {
        ...
        case STOP_DESTROY_BLOCK:
            ...
            } else if (packetIn.getStatus() == C07PacketPlayerDigging.Action.START_DESTROY_BLOCK) {
    ...
    public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn) {
        ...
        if (packetIn.getPlacedBlockDirection() == 255) {
            ...
            if (blockpos.getY() < this.serverController.getBuildLimit() - 1
                ...
                if (this.hasMoved
                        && this.playerEntity.getDistanceSq((double) blockpos.getX() + 0.5D,
                                (double) blockpos.getY() + 0.5D, (double) blockpos.getZ() + 0.5D) < 64.0D
    ...
    public void sendPacket(final Packet packetIn) {
        if (packetIn instanceof S02PacketChat) {
            ...
            if (entityplayer$enumchatvisibility == EntityPlayer.EnumChatVisibility.HIDDEN
                    || entityplayer$enumchatvisibility == EntityPlayer.EnumChatVisibility.SYSTEM
