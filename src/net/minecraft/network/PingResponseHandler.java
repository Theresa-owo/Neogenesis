        ...
        try {
            if (bytebuf.readUnsignedByte() == 254) {
                ...
                default:
                    ...
                    int l1 = bytebuf.readShort() * 2;
                    byte[] abyte1 = new byte[l1];
                    bytebuf.readBytes(abyte1);
                    flag1 = flag1 & "MC|PingHost".equals(new String(abyte1, Charsets.UTF_16BE));
                    int j = bytebuf.readUnsignedShort();
                    flag1 = flag1 & bytebuf.readUnsignedByte() >= 73;
                    int k1 = bytebuf.readShort() * 2;
                    byte[] abyte2 = new byte[k1];
                    bytebuf.readBytes(abyte2);
                    flag1 = flag1 & 3 + abyte2.length + 4 == j;
