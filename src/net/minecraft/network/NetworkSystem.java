    ...
    public SocketAddress addLocalEndpoint() {
        ...
        synchronized (this.endpoints) {
            channelfuture = ((ServerBootstrap) ((ServerBootstrap) new ServerBootstrap()
                    ...
                    }).group((EventLoopGroup) SERVER_LOCAL_EVENTLOOP.getValue()).localAddress(LocalAddress.ANY)).bind()
                            .syncUninterruptibly();
                    ...
                    if (!networkmanager.isChannelOpen()) {
                        ...
                        try {
                            ...
                            if (networkmanager.isLocalChannel()) {
                                ...
                                crashreportcategory.addCrashSectionCallable("Connection",
                                        () -> networkmanager.toString());
