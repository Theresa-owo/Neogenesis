    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        if (worldIn.getBlockState(pos).getBlock() == this) {
            ...
            if (enumfacing$axis == null
                    || enumfacing$axis == EnumFacing.Axis.Z && side != EnumFacing.EAST && side != EnumFacing.WEST) {
                return false;
            }
    ...
    public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
        ...
        for (EnumFacing.AxisDirection enumfacing$axisdirection : EnumFacing.AxisDirection.values()) {
            BlockPattern.PatternHelper blockpattern$patternhelper = new BlockPattern.PatternHelper(
                    ...
                    loadingcache, blockportal$size.func_181101_b(), blockportal$size.func_181100_a());
        ...
        return new BlockPattern.PatternHelper(
                ...
                blockportal$size.func_181101_b(), blockportal$size.func_181100_a());
    }
