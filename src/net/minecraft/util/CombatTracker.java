...
public class CombatTracker {
    ...
    public void trackDamage(DamageSource damageSrc, float healthIn, float damageAmount) {
        this.reset();
        this.func_94545_a();
        CombatEntry combatentry = new CombatEntry(damageSrc, damageAmount, this.field_94551_f,
        ...
        if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall) {
            ...
            if (combatentry.getDamageSrc() != DamageSource.fall
                ...
                if (ichatcomponent2 != null && (ichatcomponent1 == null || !ichatcomponent2.equals(ichatcomponent1))) {
                    ...
                    ItemStack itemstack = entity instanceof EntityLivingBase ? ((EntityLivingBase) entity).getHeldItem()
                            : null;
                ...
                ichatcomponent = new ChatComponentTranslation("death.fell.accident." + this.func_94548_b(combatentry),
