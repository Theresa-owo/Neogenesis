...
public enum EnumDyeColor implements IStringSerializable {
    ...
    WHITE(0, 15, "white", "white", MapColor.snowColor), ORANGE(1, 14, "orange", "orange", MapColor.adobeColor),
    MAGENTA(2, 13, "magenta", "magenta", MapColor.magentaColor),
    LIGHT_BLUE(3, 12, "light_blue", "lightBlue", MapColor.lightBlueColor),
    YELLOW(4, 11, "yellow", "yellow", MapColor.yellowColor), LIME(5, 10, "lime", "lime", MapColor.limeColor),
    PINK(6, 9, "pink", "pink", MapColor.pinkColor), GRAY(7, 8, "gray", "gray", MapColor.grayColor),
    SILVER(8, 7, "silver", "silver", MapColor.silverColor), CYAN(9, 6, "cyan", "cyan", MapColor.cyanColor),
    PURPLE(10, 5, "purple", "purple", MapColor.purpleColor), BLUE(11, 4, "blue", "blue", MapColor.blueColor),
    BROWN(12, 3, "brown", "brown", MapColor.brownColor), GREEN(13, 2, "green", "green", MapColor.greenColor),
    RED(14, 1, "red", "red", MapColor.redColor), BLACK(15, 0, "black", "black", MapColor.blackColor);
