...
public class CrashReport {
    ...
    private void populateEnvironment() {
        ...
        this.theReportCategory.addCrashSectionCallable("Operating System", () -> System.getProperty("os.name") + " ("
        ...
        this.theReportCategory.addCrashSectionCallable("Java VM Version", () -> System.getProperty("java.vm.name")
    ...
    private static String getWittyComment() {
        String[] astring = { "Who set us up the TNT?",
