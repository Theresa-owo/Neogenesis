...
public class EntityAIFollowOwner extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if ((entitylivingbase instanceof EntityPlayer && ((EntityPlayer) entitylivingbase).isSpectator()) || this.thePet.isSitting() || (this.thePet.getDistanceSqToEntity(entitylivingbase) < (double) (this.minDist * this.minDist))) {
            return false;
        } else {
