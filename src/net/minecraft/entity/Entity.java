...
import net.theresa.neogenesis.modules.culling.entityculling.Cullable;
...
public abstract class Entity implements ICommandSender, Cullable {
    ...
    public boolean loadedExtra = false;
    public boolean extraNoRender = false;
    public boolean extraNoRenderName = false;
    public boolean extraName = false;
    public String extraNameOverride;
    ...
    public boolean canShowSharpness() {
        return EnchantmentHelper.getEnchantmentLevel(16, Registry.Companion.getMc().thePlayer.getCurrentEquippedItem()) > 0 ||
                (this.canAttackWithItem() &&
                        !this.isEntityInvulnerable(DamageSource.causePlayerDamage(Registry.Companion.getMc().thePlayer)) &&
                        this.canAttackEntity() && !this.isInvisible());
    }

    public boolean canAttackEntity() { return  true; }
    /**
    ...
    public boolean isCulled() {
        return EntityCulling.Instance.getToggled() && this.culled;
    }
    ...
    public boolean isOutOfCamera() {
        return EntityCulling.Instance.getToggled() && this.outOfCamera;
    }
