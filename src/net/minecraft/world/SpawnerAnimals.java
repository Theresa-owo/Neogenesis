...
public final class SpawnerAnimals {
                                    ...
                                    if (!worldServerIn.isAnyPlayerWithinRangeAt(f, i3, f1, 24.0D)
                                        ...
                                        if (worldServerIn.canCreatureTypeSpawnHere(enumcreaturetype,
                                            ...
                                            try {
                                                ...
                                                if (entityliving == null) {
                                                    ...
                                                    this.mapSampleEntitiesByClass
                                                            .put(biomegenbase$spawnlistentry.entityClass, entityliving);
                                                }
                                            ...
                                            if (flag2) {
                                                ...
                                                ientitylivingdata = entityliving.onInitialSpawn(worldServerIn
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType spawnPlacementTypeIn,
        ...
        if (!worldIn.getWorldBorder().contains(pos) || spawnPlacementTypeIn == null) {
            return false;
        }
                ...
                for (int j1 = 0; j1 < i; ++j1) {
                    ...
                    for (int k1 = 0; !flag && k1 < 4; ++k1) {
                        ...
                        if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn,
                            ...
                            try {
                                entityliving = biomegenbase$spawnlistentry.entityClass.getConstructor(World.class)
                                        .newInstance(worldIn);
                            } catch (Exception exception1) {
                                exception1.printStackTrace();
                                continue;
