package libsrc.paulscode.sound;

import libsrc.paulscode.sound.FilenameURL;
import libsrc.paulscode.sound.Library;
import libsrc.paulscode.sound.MidiChannel;
import libsrc.paulscode.sound.SoundBuffer;
 ...
 * {@link libsrc.paulscode.sound.SoundSystemConfig SoundSystemConfig} for information 
 ...
 */
    protected libsrc.paulscode.sound.Library soundLibrary;
 ...
 * See {@link libsrc.paulscode.sound.SoundSystemConfig SoundSystemConfig} for 
 ...
 */
    public SoundSystem()
    {
        ...
        try
        {
            init( libsrc.paulscode.sound.Library.class );
            return;
        }
        catch( SoundSystemException sse )
        {
 ...
 */
    public void loadSound( String filename )
    {
        ...
        CommandQueue( new CommandObject( CommandObject.LOAD_SOUND,
                                         new libsrc.paulscode.sound.FilenameURL( filename ) ) );
        // Wake the command thread to process commands:
        commandThread.interrupt();
    }
 ...
 */
    public void loadSound( URL url, String identifier )
    {
        ...
        CommandQueue( new CommandObject( CommandObject.LOAD_SOUND,
                                         new libsrc.paulscode.sound.FilenameURL( url, identifier ) ) );
        // Wake the command thread to process commands:
        commandThread.interrupt();
    }
 ...
 */
    public void loadSound( byte[] data, AudioFormat format, String identifier )
    {
        ...
        CommandQueue( new CommandObject( CommandObject.LOAD_DATA,
                                         identifier,
                                         new libsrc.paulscode.sound.SoundBuffer( data, format ) ) );
        // Wake the command thread to process commands:
        commandThread.interrupt();
    }
 ...
 */
    ...
    {
        libsrc.paulscode.sound.FilenameURL fu = null;
        if( filename != null )
            fu = new libsrc.paulscode.sound.FilenameURL( filename );
 ...
 */
                         ...
                         long milis )
    {
        ...
        if( url != null && identifier != null )
            fu = new libsrc.paulscode.sound.FilenameURL( url, identifier );
        // Queue a command to fade out:
        CommandQueue( new CommandObject( CommandObject.FADE_OUT, sourcename, fu,
                                         milis ) );
        // Wake the command thread to process commands:
 ...
 */
                           ...
                           long milisIn )
    {
        ...
        CommandQueue( new CommandObject( CommandObject.FADE_OUT_IN,
                                         sourcename,
                                         new libsrc.paulscode.sound.FilenameURL( filename ), milisOut,
                                         milisIn ) );
        // Wake the command thread to process commands:
        commandThread.interrupt();
    }
 ...
 */    
                                 ...
                                 boolean toLoop )
    {
        ...
        CommandQueue( new CommandObject( CommandObject.QUICK_PLAY, true,
                           ...
                           new libsrc.paulscode.sound.FilenameURL( filename ), 0, 0, 0,
 ...
 */    
                           ...
                           int attmodel, float distOrRoll )
    {
        CommandQueue( new CommandObject( CommandObject.NEW_SOURCE, priority,
                                          ...
                                          new libsrc.paulscode.sound.FilenameURL( filename ), x, y, z,
                                          attmodel, distOrRoll ) );
        commandThread.interrupt();
    }
 ...
 */
                                                    ...
                                                    throws SoundSystemException
    {
        synchronized( SoundSystemConfig.THREAD_SYNC )
        {
            ...
            HashMap<String, libsrc.paulscode.sound.Source> sourceMap = null;
            ListenerData listenerData = null;

            boolean wasMidiChannel = false;
            libsrc.paulscode.sound.MidiChannel midiChannel = null;
            libsrc.paulscode.sound.FilenameURL midiFilenameURL = null;
            ...
            try
            {
                soundLibrary = (libsrc.paulscode.sound.Library) libraryClass.newInstance();
            }
 ...
 */
    private void CommandLoadSound( libsrc.paulscode.sound.FilenameURL filenameURL )
    {
        if( soundLibrary != null )
 ...
 * @param identifier What to call the sample.
 */
    private void CommandLoadSound(libsrc.paulscode.sound.SoundBuffer buffer, String identifier )
    {
        if( soundLibrary != null )
 ...
 */
    private void CommandQueueSound( String sourcename,
                                      libsrc.paulscode.sound.FilenameURL filenameURL )
    {
        if( soundLibrary != null )
 ...
 * @param milis Number of miliseconds the fadeout should take.
 */
    private void CommandFadeOut( String sourcename, libsrc.paulscode.sound.FilenameURL filenameURL,
                                   long milis )
    {
        if( soundLibrary != null )
 ...
 * @param milisIn Number of miliseconds the fadein should take.
 */
    private void CommandFadeOutIn( String sourcename, libsrc.paulscode.sound.FilenameURL filenameURL,
                                     long milisOut, long milisIn )
    {
        if( soundLibrary != null )
 ...
 */
    private void CommandNewSource(boolean priority, boolean toStream,
                                  ...
                                  libsrc.paulscode.sound.FilenameURL filenameURL, float x,
                                  float y, float z, int attModel,
                                  float distORroll )
    {
        if( soundLibrary != null )
 ...
 */
    private void CommandQuickPlay(boolean priority, boolean toStream,
                                  boolean toLoop, String sourcename,
                                  libsrc.paulscode.sound.FilenameURL filenameURL, float x, float y,
                                  float z, int attModel, float distORroll,
                                  boolean temporary )
    {
        if( soundLibrary != null )
                    ...
                    if( commandObject != null )
                    {
                        switch( commandObject.Command )
                        {
                            ...
                            case CommandObject.LOAD_SOUND:
                                CommandLoadSound(
                                        (libsrc.paulscode.sound.FilenameURL) commandObject.objectArgs[0] );
                                break;
 ...
 */    
    public boolean playing( String sourcename )
    {
        synchronized( SoundSystemConfig.THREAD_SYNC )
        {
            ...
            libsrc.paulscode.sound.Source src = soundLibrary.getSources().get( sourcename );
 ...
 */    
    public boolean playing()
    {
        synchronized( SoundSystemConfig.THREAD_SYNC )
        {
            ...
            HashMap<String, libsrc.paulscode.sound.Source> sourceMap = soundLibrary.getSources();
            if( sourceMap == null )
                return false;
            ...
            String sourcename;
            libsrc.paulscode.sound.Source source;
 ...
 */    
    private HashMap<String, libsrc.paulscode.sound.Source> copySources(HashMap<String,
            libsrc.paulscode.sound.Source> sourceMap )
    {
        Set<String> keys = sourceMap.keySet();
        Iterator<String> iter = keys.iterator();        
        String sourcename;
        ...
        HashMap<String, libsrc.paulscode.sound.Source> returnMap = new HashMap<String, libsrc.paulscode.sound.Source>();
