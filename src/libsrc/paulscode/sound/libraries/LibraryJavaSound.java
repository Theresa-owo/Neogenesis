...
import libsrc.paulscode.sound.libraries.ChannelJavaSound;
import libsrc.paulscode.sound.libraries.SourceJavaSound;
 ...
 */
    ...
    {
        return new libsrc.paulscode.sound.libraries.ChannelJavaSound( type, myMixer );
    }
 ...
 */
                           ...
                           float y, float z, int attModel, float distOrRoll )
    {
        ...
        sourceMap.put( sourcename,
                       new libsrc.paulscode.sound.libraries.SourceJavaSound( listener, priority, toStream,
 ...
 */
    ...
    {
        sourceMap.put( sourcename,
                       new libsrc.paulscode.sound.libraries.SourceJavaSound( listener, audioFormat, priority,
 ...
 */
    private static synchronized Mixer mixer( boolean action, Mixer m )
    {
        if( action == SET )
        {
            ...
            myMixer = m;
            mixerRanking( SET, mixerRanker );
            libsrc.paulscode.sound.libraries.ChannelJavaSound c;
            if( instance != null )
            {
                ...
                while( itr.hasNext() )
                {
                    c = (libsrc.paulscode.sound.libraries.ChannelJavaSound) itr.next();
                    c.newMixer( m );
                }
