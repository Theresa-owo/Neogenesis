...
import libsrc.paulscode.sound.Vector3D;
 ...
 * {@link libsrc.paulscode.sound.Vector3D Vector3D} for more information about 3D 
 ...
 */
    public libsrc.paulscode.sound.Vector3D position;
/**
 * A normalized vector indicating the direction the listener is facing
 */
    public libsrc.paulscode.sound.Vector3D lookAt;
/**
 * A normalized vector indicating the up direction
 */
    public libsrc.paulscode.sound.Vector3D up;
/**
 * Listener's velocity in world-space
 */
    public libsrc.paulscode.sound.Vector3D velocity;
 ...
 */
    public ListenerData()
    {
        position = new libsrc.paulscode.sound.Vector3D( 0.0f, 0.0f, 0.0f );
        lookAt = new libsrc.paulscode.sound.Vector3D( 0.0f, 0.0f, -1.0f );
        up = new libsrc.paulscode.sound.Vector3D( 0.0f, 1.0f, 0.0f );
        velocity = new libsrc.paulscode.sound.Vector3D( 0.0f, 0.0f, 0.0f );
        angle = 0.0f;
    }
 ...
 */
    ...
    {
        position = new libsrc.paulscode.sound.Vector3D( pX, pY, pZ );
        lookAt = new libsrc.paulscode.sound.Vector3D( lX, lY, lZ );
        up = new libsrc.paulscode.sound.Vector3D( uX, uY, uZ );
        velocity = new libsrc.paulscode.sound.Vector3D( 0.0f, 0.0f, 0.0f );
        angle = a;
    }
 ...
 * @param a Angle in radians that the listener is turned counterclockwise around the y-axis.
 */
    public ListenerData(libsrc.paulscode.sound.Vector3D p, libsrc.paulscode.sound.Vector3D l, libsrc.paulscode.sound.Vector3D u, float a )
    {
        position = p.clone();
        lookAt = l.clone();
        up = u.clone();
 ...
 * @param a Angle in radians that the listener is turned counterclockwise around the y-axis.
 */
    public void setData(libsrc.paulscode.sound.Vector3D p, libsrc.paulscode.sound.Vector3D l, libsrc.paulscode.sound.Vector3D u, float a )
    {
        position.x = p.x;
        position.y = p.y;
        position.z = p.z;
 ...
 */
    public void setPosition( libsrc.paulscode.sound.Vector3D p )
    {
        position.x = p.x;
        position.y = p.y;
        position.z = p.z;
 ...
 */
    public void setOrientation(libsrc.paulscode.sound.Vector3D l, libsrc.paulscode.sound.Vector3D u )
    {
        lookAt.x = l.x;
        lookAt.y = l.y;
        lookAt.z = l.z;
