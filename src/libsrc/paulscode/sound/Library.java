...
import libsrc.paulscode.sound.Channel;
 ...
 */
    protected HashMap<String, libsrc.paulscode.sound.Source> sourceMap;  // (name, source data) pairs
 ...
 */
    protected List<libsrc.paulscode.sound.Channel> streamingChannels;
    
/**
 * Array containing maximum number of non-streaming audio channels.
 */
    protected List<libsrc.paulscode.sound.Channel> normalChannels;
 ...
 */
    public Library() throws SoundSystemException
    {
        ...
        sourceMap = new HashMap<String, libsrc.paulscode.sound.Source>();
        ...
        streamingChannels = new LinkedList<libsrc.paulscode.sound.Channel>();
        normalChannels = new LinkedList<libsrc.paulscode.sound.Channel>();
 ...
 */
    public void cleanup()
    {
        ...
        libsrc.paulscode.sound.Channel channel = null;
 ...
 */
    protected libsrc.paulscode.sound.Channel createChannel(int type )
    {
        return new libsrc.paulscode.sound.Channel( type );
    }
 ...
 */
                               ...
                               float posZ, int attModel, float distOrRoll )
    {
        sourceMap.put( sourcename,
                       new libsrc.paulscode.sound.Source( audioFormat, priority, sourcename, posX,
 ...
 */
    ...
    {
        sourceMap.put( sourcename,
                       new libsrc.paulscode.sound.Source( priority, toStream, toLoop, sourcename,
 ...
 */
    ...
    {
        libsrc.paulscode.sound.Source mySource = sourceMap.get( sourcename );
        if( mySource != null )
 ...
 */
    public float millisecondsPlayed( String sourcename )
    {
        ...
        {
            libsrc.paulscode.sound.Source source = sourceMap.get( sourcename );
            if( source == null )
            {
 ...
 * @return Number of prior buffers that have been processed, or -1 if unable to queue the buffer (if the source was culled, for example).
 */
    public int feedRawAudioData(libsrc.paulscode.sound.Source source, byte[] buffer )
    {
        if( source == null )
        {
        ...
        {
            libsrc.paulscode.sound.Channel channel;
 ...
 */
    public void play( libsrc.paulscode.sound.Source source )
    {
        if( source == null )
            return;
        ...
        if( !source.playing() )
        {
            libsrc.paulscode.sound.Channel channel = getNextChannel( source );
 ...
 */
    public void copySources( HashMap<String, libsrc.paulscode.sound.Source> srcMap )
    {
        if( srcMap == null )
            return;
        ...
        Iterator<String> iter = keys.iterator();        
        String sourcename;
        libsrc.paulscode.sound.Source srcData;
        ...
        while( iter.hasNext() )
        {
            ...
            if( srcData != null )
            {
                ...
                sourceMap.put( sourcename, new libsrc.paulscode.sound.Source( srcData, null ) );
            }
        }
    }
 ...
 */
    private libsrc.paulscode.sound.Channel getNextChannel(libsrc.paulscode.sound.Source source )
    {
        if( source == null )
            return null;
        ...
        int channels;
        int nextChannel;
        List<libsrc.paulscode.sound.Channel> channelList;
        String[] sourceNames;
        String name;
        ...
        int n = nextChannel;
        libsrc.paulscode.sound.Source src;
 ...
 */
    public void checkFadeVolumes()
    {
        if( midiChannel != null )
            midiChannel.resetGain();
        Channel c;
        libsrc.paulscode.sound.Source s;
 ...
 */
    public libsrc.paulscode.sound.Source getSource(String sourcename )
    {
