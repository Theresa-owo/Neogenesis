 ...
 */
    private libsrc.paulscode.sound.FilenameURL filenameURL;
 ...
 */
    private LinkedList<libsrc.paulscode.sound.FilenameURL> sequenceQueue = null;
 ...
 */
    public MidiChannel( boolean toLoop, String sourcename, String filename )
    {
        ...
        filenameURL( SET, new libsrc.paulscode.sound.FilenameURL( filename ) );
 ...
 */
                        ...
                        String identifier )
    {
        ...
        // save information about the source:
        filenameURL( SET, new libsrc.paulscode.sound.FilenameURL( midiFile, identifier ) );
        sourcename( SET, sourcename );
        setLooping( toLoop );
 ...
 */
    public MidiChannel( boolean toLoop, String sourcename,
                        libsrc.paulscode.sound.FilenameURL midiFilenameURL )
    {
        // let others know we are busy loading
        loading( SET, true );
 ...
 */
    public void queueSound( libsrc.paulscode.sound.FilenameURL filenameURL )
    {
        if( filenameURL == null )
        {
        ...
        {
            if( sequenceQueue == null )
                sequenceQueue = new LinkedList<libsrc.paulscode.sound.FilenameURL>();
 ...
 */
    public void dequeueSound( String filename )
    {
        ...
        synchronized( sequenceQueueLock )
        {
            if( sequenceQueue != null )
            {
                ListIterator<libsrc.paulscode.sound.FilenameURL> i = sequenceQueue.listIterator();
                while( i.hasNext() )
                {
 ...
 */
    public void fadeOut(libsrc.paulscode.sound.FilenameURL filenameURL, long milis )
    {
        if( milis < 0 )
        {
 ...
 */
    public void fadeOutIn(libsrc.paulscode.sound.FilenameURL filenameURL, long milisOut,
                          long milisIn )
    {
        if( filenameURL == null )
        {
 ...
 */
    public void setFilenameURL( libsrc.paulscode.sound.FilenameURL value )
    {
 ...
 */
    public libsrc.paulscode.sound.FilenameURL getFilenameURL()
    {
 ...
 */
    private synchronized libsrc.paulscode.sound.FilenameURL filenameURL(boolean action,
                                                                 FilenameURL value )
    {
        if( action == SET )
            filenameURL = value;
