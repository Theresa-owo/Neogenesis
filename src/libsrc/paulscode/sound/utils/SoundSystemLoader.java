package libsrc.paulscode.sound.utils;
                    ...
                    else
                    {
                        if( verbose )
                            message( "Command:  s.CommandQueue( new " +
                                     "libsrc.paulscode.sound.CommandObject( " +
                                     "libsrc.paulscode.sound.CommandObject." +
                                     "NEW_SOURCE, " + priority + ", " +
                                     toStream + ", " + toLoop + ", \"" +
                                     sourcename + "\", " +
                                     "new libsrc.paulscode.sound.FilenameURL( \"" +
                                     filename + "\" ), " + x + ", " + y + ", " +
                                     z + ", " + attModel + ", " + distOrRoll +
                                     " ) );", 1 );
                        s.CommandQueue( new libsrc.paulscode.sound.CommandObject(
                            libsrc.paulscode.sound.CommandObject.NEW_SOURCE, priority,
                            toStream, toLoop, sourcename,
                            new libsrc.paulscode.sound.FilenameURL( filename ), x, y,
                            z, attModel, distOrRoll ) );
                        if( verbose )
