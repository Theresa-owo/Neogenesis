...
import libsrc.paulscode.sound.IStreamListener;
 ...
 * overridding the {@link libsrc.paulscode.sound.SoundSystemLogger SoundSystemLogger} 
 ...
 */
    private static LinkedList<libsrc.paulscode.sound.IStreamListener> streamListeners = null;
/**
...
*/
                                                     ...
                                                     throws SoundSystemException
    {
        ...
        if( !libsrc.paulscode.sound.Library.class.isAssignableFrom( libraryClass ) )
                                                     ...
                                                     throws SoundSystemException
    {
        ...
        if( iCodecClass == null )
            throw new SoundSystemException( "Parameter 'iCodecClass' null in " +
                                          "method 'setCodec'.",
                                          SoundSystemException.NULL_PARAMETER );
        if( !libsrc.paulscode.sound.ICodec.class.isAssignableFrom( iCodecClass ) )
 ...
 */
    public static synchronized libsrc.paulscode.sound.ICodec getCodec(String filename )
    {
        if( codecs == null )
            return null;
...
*/
    public static void addStreamListener( libsrc.paulscode.sound.IStreamListener streamListener )
    {
        synchronized( streamListenersLock )
        {
            if( streamListeners == null )
                streamListeners = new LinkedList<libsrc.paulscode.sound.IStreamListener>();
 ...
 * @param streamListener Implementation of interface 'IStreamListener'.
*/
    public static void removeStreamListener( libsrc.paulscode.sound.IStreamListener streamListener )
    {
        ...
        new Thread()
        {
            ...
            public void run()
            {
                synchronized( streamListenersLock )
                {
                    if( streamListeners == null )
                        return;
                    ListIterator<libsrc.paulscode.sound.IStreamListener> i = streamListeners.listIterator();
 ...
 */
        ...
        public libsrc.paulscode.sound.ICodec getInstance()
        {
            if( iCodecClass == null )
                return null;
