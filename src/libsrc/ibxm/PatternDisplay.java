...
public class PatternDisplay extends Canvas {
	...
	public synchronized void display( libsrc.ibxm.Module module, int pat, int row ) {
		libsrc.ibxm.Pattern pattern = module.patterns[ pat ];
		...
		libsrc.ibxm.Note note = new libsrc.ibxm.Note();
